...
@Component({
  selector: 'app-digital-branding-scheduling',
  templateUrl: './digital-branding-scheduling.component.html',
  styleUrls: ['./digital-branding-scheduling.component.scss']
})
export class DigitalBrandingSchedulingComponent implements OnInit {
    ...
    this.digitalBrandingService.saveEmpresaBranding(this.empresa).subscribe(
      (data: any) => {
        ...
        Swal.fire({
          ...
          this.router.navigate(["/branding-digital"]);
        });
