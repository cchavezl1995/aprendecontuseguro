...
@Component({
  selector: 'app-scheduling-fraude',
  templateUrl: './scheduling-fraude.component.html',
  styleUrls: ['./scheduling-fraude.component.scss']
})
export class SchedulingFraudeComponent implements OnInit {
        ...
        this.booking.addSchedule(this.formContact.value).subscribe(
          res => {
            ...
            if (res['codigo'] == 0) {
              ...
              Swal.fire({
                title: 'Agendado',
                text: `Se ha relizado el agendamiento exitosamente!.`,
                type: 'success',
                confirmButtonText: 'Aceptar'
              }).then((result) => {
        ...
        this.booking.updateSchedule(this.formContact.value).subscribe(
          res => {
            ...
            if (res['codigo'] == 0) {
              Swal.fire({
                title: 'Actualizado',
                text: `Se ha relizado la actulización exitosamente!.`,
                type: 'success',
                confirmButtonText: 'Aceptar'
              }).then(
                res => {
  ...
  delete(id) {
    Swal.fire({
      title: 'Cancelación',
      text: "¿Estás seguro de cancelar este agendamiento?",
      type: 'warning',
