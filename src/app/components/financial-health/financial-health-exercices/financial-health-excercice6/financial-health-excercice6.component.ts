...
@Component({
  selector: 'app-financial-health-excercice6',
  templateUrl: './financial-health-excercice6.component.html',
  styleUrls: ['./financial-health-excercice6.component.scss']
})
export class FinancialHealthExcercice6Component implements OnInit {
