...
@Component({
  selector: 'app-financial-health-excercice10',
  templateUrl: './financial-health-excercice10.component.html',
  styleUrls: ['./financial-health-excercice10.component.scss']
})
export class FinancialHealthExcercice10Component implements OnInit {
  constructor(public login: LoginService, public sf: SaludfinService,  private route: ActivatedRoute) { }
  pagina: number;
  section: number = 1;
  subSection: number = 1;
