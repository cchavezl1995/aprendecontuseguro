...
@Component({
  selector: 'app-financial-health-exercices',
  templateUrl: './financial-health-exercices.component.html',
  styleUrls: ['./financial-health-exercices.component.scss']
})
export class FinancialHealthExercicesComponent implements OnInit {
