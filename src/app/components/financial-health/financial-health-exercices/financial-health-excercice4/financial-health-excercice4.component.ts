...
@Component({
  selector: 'app-financial-health-excercice4',
  templateUrl: './financial-health-excercice4.component.html',
  styleUrls: ['./financial-health-excercice4.component.scss']
})
export class FinancialHealthExcercice4Component implements OnInit {
