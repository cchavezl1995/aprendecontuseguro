...
@Component({
  selector: 'app-financial-health-excercice8',
  templateUrl: './financial-health-excercice8.component.html',
  styleUrls: ['./financial-health-excercice8.component.scss']
})
export class FinancialHealthExcercice8Component implements OnInit {
