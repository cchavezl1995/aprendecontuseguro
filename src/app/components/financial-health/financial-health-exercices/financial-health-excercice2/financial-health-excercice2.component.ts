...
@Component({
  selector: 'app-financial-health-excercice2',
  templateUrl: './financial-health-excercice2.component.html',
  styleUrls: ['./financial-health-excercice2.component.scss']
})
export class FinancialHealthExcercice2Component implements OnInit {
