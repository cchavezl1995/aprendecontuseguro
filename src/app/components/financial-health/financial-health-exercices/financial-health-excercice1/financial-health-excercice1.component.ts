...
@Component({
  selector: 'app-financial-health-excercice1',
  templateUrl: './financial-health-excercice1.component.html',
  styleUrls: ['./financial-health-excercice1.component.scss']
})
export class FinancialHealthExcercice1Component implements OnInit {
