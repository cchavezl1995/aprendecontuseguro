...
@Component({
  selector: 'app-financial-health-excercice9',
  templateUrl: './financial-health-excercice9.component.html',
  styleUrls: ['./financial-health-excercice9.component.scss']
})
export class FinancialHealthExcercice9Component implements OnInit {
