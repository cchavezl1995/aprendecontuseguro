...
@Component({
  selector: 'app-financial-health-excercice5',
  templateUrl: './financial-health-excercice5.component.html',
  styleUrls: ['./financial-health-excercice5.component.scss']
})
export class FinancialHealthExcercice5Component implements OnInit {
